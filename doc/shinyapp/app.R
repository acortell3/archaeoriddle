           ...
           tabsetPanel(
             ...
             tabPanel(HTML("<p style='font-family:Courier New'><b>News and comments</b></p>"),
                      ...
                      fluidRow(
                        ...
                        column(width = 5,
                               strong(tags$h2(style='font-weight:900;color:white;font-family:Courier New'," The Archaeoriddle Workshop, Saturday the 2nd of September 2023, Lanyon Building, room G059")),                      
							   tags$br(),
