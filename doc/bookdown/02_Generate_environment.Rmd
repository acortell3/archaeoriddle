...
An important aspect of the simulation is a way to generate elevation and slope. To generate 2D autocorrelation we used a slightly method known as [perlin noise](https://en.wikipedia.org/wiki/Perlin_noise) ; using the implementation found on [this stackoverflow.com post](https://stackoverflow.com/questions/15387328/realistic-simulated-elevation-data-in-r-perlin-noise).
...
according to a logistic function. We provide a very basic function `logisticdecay` which allows you to define multiple sources with different decay arrays around them.
...
We then loop over all center manually defined previously and apply the logistic decay within the `viable` raster.
