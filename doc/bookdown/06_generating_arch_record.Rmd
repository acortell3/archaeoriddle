# Generate Archaeological remain and squares
...
if(class(sites)[1]=="PackedSpatVector") sites=vect(sites)
Nts=onesimu$Nts
...
if(class(allsites)[1]=="PackedSpatVector") allsites=vect(allsites)
