...
cat('<video controls> <source  src="data_original/run_selection/web_buffattack300_K110_PSU065_1_out.mp4" type="video/mp4"></video>')
cat('<video controls> <source  src="data_original/run_selection/web_buffattack300_K110_3_out.mp4" type="video/mp4"></video>')
cat('<video controls> <source  src="data_original/run_selection/web_buffattack300_1_out.mp4" type="video/mp4"></video>')
cat('<video controls> <source  src="data_original/run_selection/web_buffattack300_3_out.mp4" type="video/mp4"></video>')
```
...
Again, this is stochastic (the selection of the fake standard variation added is radom), so the exact results can't be reproduced exactly, although in that case this steps doesn't change anything, the outcome of this steps is available in the folder [data_original/all_squares.oc/](./data_original/all_squares.oc/).
