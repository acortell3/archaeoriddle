...
We will also save the different object generated by `run_simulation` to be able to re-load it, share it, analyse it, later. 
...
plot(onesimu$site, cex=(1+Nts[1,]/100), pch=21, bg=rainbow(2, alpha=0.6)[as.factor(onesimu$site$culture)])
```
