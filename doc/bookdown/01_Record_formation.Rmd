...
* **Population**: The size of the group at each time step. Discrete variable with range $[0,K]$.
* **Site type**: This represent whether the site is a cave, a rockshelter or an open-air site. Therefore, this is a categoric variable with three possible values.
...
* **Mobility pattern**: In this case, we have considered different mobility strategies, which can affect, directly or indirectly, the formation of the record. We have considered five three possible strategies: "residential", "logistic" and "sedentary". Thus, a categorical variable with three possible outcomes.
* **Site functionality**: Five different possible sites uses have been considered: "habitat", "logistic", "pen", "butcher" and "funeral", giving a categorical variable with five possible outcomes.
