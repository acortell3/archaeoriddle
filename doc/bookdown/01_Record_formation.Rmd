...
knitr::spin('../../R/anthropogenic_deposition.R', format='Rmd', comment=c("#'","#'"),
            precious=TRUE, knit=FALSE, report=FALSE)
fs::file_move('../../R/anthropogenic_deposition.Rmd', '.')
```

```{r child='anthropogenic_deposition.Rmd'}
```
...
```{r, echo=FALSE, message=FALSE}
knitr::spin('../../R/natural_deposition.R', format='Rmd', comment=c("#'","#'"),
            precious=TRUE, knit=FALSE, report=FALSE)
fs::file_move('../../R/natural_deposition.Rmd', '.')
```

```{r child='natural_deposition.Rmd'}
```
