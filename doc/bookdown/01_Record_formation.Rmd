...
Gpd <- function(x, W_fert_age = c(10,30), M_fer_age = c(15,40),
                P_o = 0.3){
...
Once this is done, we can implement the protocol one, where we compute the population during the desired time span.
