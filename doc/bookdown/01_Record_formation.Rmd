...
In order to fully understand the process, first we will show the protocols and functions used. To start with, let's load the package with the functions functions:
...
```{r, echo=FALSE}
help.search(
  '(Gpd)|(death)|(K_lim)|(Pop_stoch)|(A_rates)|(D_along)',
  package = 'archaeoriddle')
```
...
fs::file_move('../../R/population.Rmd', 'spin_functions/')
```
...
res = knitr::knit_child(input='spin_functions/population.Rmd', quiet=TRUE)
cat(res, sep = '\n')
```
</details>
...
a = knitr::spin('../../R/anthropogenic_deposition.R', format='Rmd', comment=c("#'","#'"),
            precious=TRUE, knit=FALSE, report=FALSE)
fs::file_move('../../R/anthropogenic_deposition.Rmd', 'spin_functions/')
```
...
```{r, echo=FALSE, results='asis'}
res = knitr::knit_child(input='spin_functions/anthropogenic_deposition.Rmd', quiet=TRUE)
cat(res, sep = '\n')
```
</details>
...
a = knitr::spin('../../R/natural_deposition.R', format='Rmd', comment=c("#'","#'"),
            precious=TRUE, knit=FALSE, report=FALSE)
fs::file_move('../../R/natural_deposition.Rmd', 'spin_functions/')
```
...
**Code**
```{r, echo=FALSE, results='asis'}
res = knitr::knit_child(input='spin_functions/natural_deposition.Rmd', quiet=TRUE)
cat(res, sep = '\n')
```
</details>
