...
## Implementation
This layer of the model is less complex than the previous one. In this case, we only need to apply the loss of the record on the already created sample, according to the different loss probabilities. The functions for this are used as follows.
...
fs::file_move('../../R/record_loss.Rmd', 'spin_functions/')
```

You can check the code for the short and long-term loss functions here:
<details><summary>Show code</summary>
**Code**
```{r, echo=FALSE, results='asis'}
res = knitr::knit_child(input='spin_functions/record_loss.Rmd', quiet=TRUE)
cat(res, sep = '\n')
```
</details>
<br>
