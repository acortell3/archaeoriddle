...
## Implementation
This model is constituted of two layers. A first layer implements the loss of the record, while the second layer accounts for the processes which may affect its vertical displacement, resulting chronological palimpsests. In order to understand the process, first we show the protocols and functions that we use to generate each variable.
