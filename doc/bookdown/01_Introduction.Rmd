...
5. Chapter&nbsp;\@ref(main-simu) [Main simulation:](#main-simu) the main function that wraps together the previous elements to simulate the interactions processes.
...
9. Chapter&nbsp;\@ref(original-challenge) [Archaoriddle: the original challenge:](#orignal-challenge)  The full description of the parameters, runs and data generated, as well as the 5 proposals gathered for the original challenge.
