...
4. we defined processes that use this simulate growth to generate an archaeological record in Chapter \@ref(genrec}
5. we defined processes that transform this archaeological record using credible loss \@ref(genrec}
...
First we get the rasters defining the environment (If you folllowed the book since the beginning they should be already in memory but in case you didn't we we reload them here:
