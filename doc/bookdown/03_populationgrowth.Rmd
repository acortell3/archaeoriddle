...
K=2000+faketemp*sample(100:200,size=tstep,replace=T)
N=100
pop=rep(0,tstep)
pop[1]=N
...
```{r visupopgrowth,fig.cap="logistic growth and correlated data",out.width="100%",fig.height=4,fig.width=9,fig.show="hold",cache=F}
