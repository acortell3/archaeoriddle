...
Let's Create a fake environment. We use the `envrnment` function, which in turns
...
tstep <- 1000
faketemp <- envrnment(tstep, omega=3, delta=1.5) + 1.5
...
You can inspect the code of `envrnment` and `TK95` functions here:
