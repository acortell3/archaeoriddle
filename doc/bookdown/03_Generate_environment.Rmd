...
Let's Create a fake environment. We use the `envrment` function, which in turns
...
tstep <- 1000
faketemp <- envrment(tstep, omega=3, delta=1.5) + 1.5
...
You can inspect the code of `envrment` and `TK95` functions here:
