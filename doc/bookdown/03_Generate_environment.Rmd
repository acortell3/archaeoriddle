...
## Function 10. Noise from Kimmer and Koening
#' @title Noise from Kimmer and Koening
...
#' Return a list of opitmum as a "1/f-noise" of N steps with sd = delta and
#' the slope of it's spectrum decompoistion = -omega + possibility to increase
